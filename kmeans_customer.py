...
df = pd.read_excel(r'C:\Users\luluo\Documents\SurvivalAnalysisLTV\LTV_V1212.xlsx', 'student_row')
...
# IMPORTING DATA
#['active_boolean', 'tenure', 'gender', 'servicio_telefonico', 'buscando_empleo', 'has_bogo']
#features_to_drop = ['salesforce_contact_id', 'active_boolean', 'tenure', 'gender', 'country', 'servicio_telefonico', 'buscando_empleo', 'has_bogo']
#df = pd.read_csv('cust_seg.csv')
df.drop('Unnamed: 0', axis = 1, inplace = True)
df.set_index('salesforce_contact_id', inplace = True)
...
print(cl(df['clean_age'].describe(), attrs = ['bold']))

sb.distplot(df['clean_age'],
            color = 'orange')
